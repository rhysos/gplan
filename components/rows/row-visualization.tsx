...
interface RowVisualizationProps {
  row: GardenRow
  onRemovePlant: (plantInstanceId: number, plantId: number) => void
  onMovePlant: (plantIndex: number, direction: "left" | "right") => void
  isMovingPlant: boolean
}

export function RowVisualization({ row, onRemovePlant, onMovePlant, isMovingPlant }: RowVisualizationProps) {
                  ...
                  <div className="relative w-full h-full flex items-center justify-center">
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-1">
                      ...
                      <Button
                        ...
                        onClick={() => !isFirst && !isMovingPlant && onMovePlant(index, "left")}
                        disabled={isFirst || isMovingPlant}
                      >
                      ...
                      <Button
                        ...
                        onClick={() => onRemovePlant(plantInstance.id, plantInstance.plant_id)}
                      >
                      ...
                      <Button
                        ...
                        onClick={() => !isLast && !isMovingPlant && onMovePlant(index, "right")}
                        disabled={isLast || isMovingPlant}
                      >
