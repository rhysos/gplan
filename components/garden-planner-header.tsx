...
interface GardenPlannerHeaderProps {
  ...
  setIsAddingGarden: (open: boolean) => void
...
const GardenPlannerHeader: React.FC<GardenPlannerHeaderProps> = ({
  gardens,
  currentGardenId,
  setCurrentGardenId,
  setIsAddingGarden,
  ...
  return (
    <header className="mb-4">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        {/* Garden Selector and Instructions Button */}
        ...
        {/* Instructions Button for Desktop */}
...
export default GardenPlannerHeader
